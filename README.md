...
1. How would you describe acessibility on the web to someone new to programming?
        Accessibility allows for inclusivity of disabilities such as blindness/deafness, with the use of screen readers for example.

2. Talk about 3 different things you can do to ensure your website is accessible. 
        Include 'alt' tags on image/visual elements so that the image content can be read aloud. Using media queries to style your sit to be responsive to various device sizes, making sure the information maintains its format and readability.

3. How would you explain the concept of a variable to someone new to programming?
        A variable is like a container that holds a bit of information.

4. What is the purpose of using functions in code?
        Functions serve a purpose of being resuable bits of code. So you can use the function over and over, by simply using the parameters to pass in the specific data requirements. 
